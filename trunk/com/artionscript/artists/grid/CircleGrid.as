package com.artionscript.artists.grid 
{
	 ...
	 * @author Trevor Boyle
	 */
	public class CircleGrid extends Grid
	{
		public function CircleGrid(canvas:Canvas, inspiration:Inspiration=null, palette:Palette=null) {
		...
		override protected function setVariables():void {
			...
			include "includes/CircleGridVariables.as";
		}
